...
let filterModule = require("./learnyounode-6-module.js");
    
if (process.argv.length != 4) return console.error("invalid arguments");

let directory = process.argv[2],
    extension = process.argv[3];

filterModule(directory, extension, (err, data) => {
    if (err) {
        console.error(err);
    } else {
